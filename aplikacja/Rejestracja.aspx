...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel runat="server" ID="formRejestracja" DefaultButton="btnRejestruj" ValidationGroup="formRejestracja">
        <br />
        <p>Uzupełnij dane formularza:</p>
        <div class="nice-form">
            <div class="form-group">
                <asp:TextBox class="form-control" runat="server" ID="txtImie" MaxLength="100" placeholder="Imię" ValidationGroup="formRejestracja"></asp:TextBox>
            ...
            <div class="form-group">
                <asp:TextBox class="form-control" ValidationGroup="formRejestracja" runat="server" ID="txtNazwisko" MaxLength="100" placeholder="Nazwisko"></asp:TextBox>
            ...
            <div class="form-group">
                <asp:TextBox class="form-control" ValidationGroup="formRejestracja" runat="server" ID="txtEmail" MaxLength="100" placeholder="Email" ></asp:TextBox>
            ...
            <div class="form-group">
                <asp:TextBox class="form-control" ValidationGroup="formRejestracja" runat="server" ID="txtHaslo" MaxLength="100" placeholder="Hasło" TextMode="Password"></asp:TextBox>
            ...
            <div class="form-group">
                <asp:TextBox class="form-control" ValidationGroup="formRejestracja" runat="server" ID="txtHasloPowtorzenie" placeholder="Powtórz hasło" TextMode="Password"></asp:TextBox>
