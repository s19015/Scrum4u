...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		prevText: "Następny", // Display text for previous month link
		nextText: "Poprzedni", // Display text for next month link
		...
		monthNamesShort: ["Sty", "Lut", "Mar", "Kwi", "Maj", "Czer", "Lip", "Sie", "Wrz", "Paź", "Lis", "Gru"], // For formatting
		dayNames: ["Niedziela", "Poniedziałek", "Wtorek", "Środa", "Czwartek", "Piątek", "Sobota"], // For formatting
		dayNamesShort: ["Ndz", "Pon", "Wto", "Śro", "Czw", "Pią", "Sob"], // For formatting
		dayNamesMin: ["Nd","Pn","Wt","Śr","Cz","Pi","So"], // Column headings for days starting at Sunday
